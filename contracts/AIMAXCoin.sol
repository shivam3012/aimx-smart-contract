...
contract AIMAXCoin is ERC20BurnableUpgradeable, OwnableUpgradeable {
    ...
    modifier onlyAllowed() {
        require(allowed[_msgSender()], "AIMAXCoin: Not allowed");
        _;
    }
